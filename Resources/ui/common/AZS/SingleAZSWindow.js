...
function SingleAZSWindow(e) {
    ...
    Data.getStationById(data.id, function(success, d) {
        if (success) {
            //data = makeTableData(d);
            //table.setData(data);
            table.setSections(makeDataList(d));
        }
    });
